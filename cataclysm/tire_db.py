...
_CURATED_TIRES: dict[str, TireSpec] = {
    ...
    # =======================================================================
    # SUPER 200TW — Cup 2 R variant
    # =======================================================================
    "michelin_cup2r": TireSpec(
        model="Michelin Pilot Sport Cup 2 R",
        compound_category=TireCompoundCategory.SUPER_200TW,
        size="varies",
        treadwear_rating=200,
        estimated_mu=1.15,
        mu_source=MuSource.CURATED_TABLE,
        mu_confidence="Cup 2 R = stiffer construction Cup 2, same compound. TW 200.",
        brand="Michelin",
    ),
    "dunlop_sport_maxx_race": TireSpec(
        model="Dunlop Sport Maxx Race",
        compound_category=TireCompoundCategory.SUPER_200TW,
        size="varies",
        treadwear_rating=200,
        estimated_mu=1.08,
        mu_source=MuSource.CURATED_TABLE,
        mu_confidence="OEM on STI S209/Type RA. ~200TW track compound.",
        brand="Dunlop",
    ),
    "dunlop_gt600_dsst": TireSpec(
        model="Dunlop SP Sport Maxx GT 600 DSST",
        compound_category=TireCompoundCategory.SUPER_200TW,
        size="varies",
        treadwear_rating=200,
        estimated_mu=1.05,
        mu_source=MuSource.CURATED_TABLE,
        mu_confidence="GT-R NISMO OEM run-flat. ~5% penalty vs non-RF. Track-biased compound.",
        brand="Dunlop",
    ),
    # =======================================================================
    # ENDURANCE 200TW — Additional entries
    # =======================================================================
    "continental_cs6": TireSpec(
        model="Continental ContactSport 6",
        compound_category=TireCompoundCategory.ENDURANCE_200TW,
        size="varies",
        treadwear_rating=200,
        estimated_mu=1.00,
        mu_source=MuSource.CURATED_TABLE,
        mu_confidence="200TW OEM-ish, similar to RS4 class.",
        brand="Continental",
    ),
    "falken_rt615k": TireSpec(
        model="Falken Azenis RT615K+",
        compound_category=TireCompoundCategory.ENDURANCE_200TW,
        size="varies",
        treadwear_rating=200,
        estimated_mu=1.05,
        mu_source=MuSource.CURATED_TABLE,
        mu_confidence="200TW older design, endurance focus. Similar to RT660.",
        brand="Falken",
    ),
    "yokohama_ad07": TireSpec(
        model="Yokohama Advan AD07",
        compound_category=TireCompoundCategory.ENDURANCE_200TW,
        size="varies",
        treadwear_rating=180,
        estimated_mu=1.02,
        mu_source=MuSource.CURATED_TABLE,
        mu_confidence="180TW predecessor to AD08/AD09. Endurance-level.",
        brand="Yokohama",
    ),
    # =======================================================================
    # STREET — Additional OEM tires
    # =======================================================================
    "kumho_ecsta_k127": TireSpec(
        model="Kumho Ecsta S1 Evo3 K127",
        compound_category=TireCompoundCategory.STREET,
        size="varies",
        treadwear_rating=340,
        estimated_mu=0.88,
        mu_source=MuSource.CURATED_TABLE,
        mu_confidence="340TW UHP street. HPWizard: 2.25/340^0.15=0.85, +3% modern compound.",
        brand="Kumho",
    ),
    "firestone_indy500_340tw": TireSpec(
        model="Firestone Firehawk Indy 500",
        compound_category=TireCompoundCategory.STREET,
        size="varies",
        treadwear_rating=340,
        estimated_mu=0.88,
        mu_source=MuSource.CURATED_TABLE,
        mu_confidence="340TW UHP. HPWizard: ~0.85, +3% modern compound. GRM budget tier.",
        brand="Firestone",
    ),
    "dunlop_sp600_dsst": TireSpec(
        model="Dunlop SP Sport 600 DSST",
        compound_category=TireCompoundCategory.STREET,
        size="varies",
        treadwear_rating=200,
        estimated_mu=0.85,
        mu_source=MuSource.CURATED_TABLE,
        mu_confidence="GT-R OEM run-flat street. Run-flat penalty + street compound.",
        brand="Dunlop",
    ),
    "michelin_primacy3": TireSpec(
        ...
        estimated_mu=0.85,
        mu_source=MuSource.CURATED_TABLE,
        mu_confidence="240TW touring/comfort tire. BRZ OEM.",
        brand="Michelin",
    ),
