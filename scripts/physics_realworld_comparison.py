...
CURATED_LAP_TIMES: list[RealWorldLapTime] = [
    ...
    RealWorldLapTime(
        ...
        tire_db_key="firestone_indy500_340tw",
        source_quality="aggregated",
    ),
    RealWorldLapTime(
        car_key=("Volkswagen", "Golf R", None),
    ...
    RealWorldLapTime(
        ...
        tire_db_key="dunlop_sport_maxx_race",
        source_quality="professional",
        driver_level="pro",
    ),
